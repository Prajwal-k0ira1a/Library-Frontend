...
const Explore = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      count: "8,230",
      image:
        "https://images.pexels.com/photos/256262/pexels-photo-256262.jpeg?auto=compress&cs=tinysrgb&w=400",
    },
    {
      name: "History",
      count: "5,670",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Dive into our vast collection of books across various genres and
            ...
            {popularBooks.map((book, index) => (
              ...
              >
                <div className="space-y-4">
                  ...
                  <button
                    onClick={() => navigate("/login")}
                    className="w-full bg-gradient-to-r from-blue-600 to-teal-600 text-white py-2 rounded-lg font-medium hover:shadow-lg transition-all duration-200"
                  >
                    Read Now
                  </button>
                </div>
