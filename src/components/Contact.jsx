...
const Contact = () => {
  ...
  const getInputClassName = (fieldName) => {
    const baseClasses =
      "w-full px-6 py-4 rounded-2xl border-2 focus:ring-4 outline-none transition-all duration-300 bg-white/70 backdrop-blur-sm text-gray-800 placeholder-gray-500 font-medium";
    const errorClasses =
      "border-red-400 focus:border-red-500 focus:ring-red-500/30 shadow-lg shadow-red-500/10";
    const normalClasses =
      "border-gray-200/60 focus:border-indigo-400 focus:ring-indigo-500/30 hover:border-indigo-300 hover:shadow-lg hover:shadow-indigo-500/10";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-br from-indigo-400/20 to-blue-600/20 rounded-full blur-3xl animate-pulse"></div>
        <div
          className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-br from-blue-400/20 to-blue-600/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-br from-emerald-400/20 to-teal-600/20 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-500 via-blue-600 to-blue-500 rounded-3xl mb-8 shadow-2xl shadow-indigo-500/30 relative">
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 via-blue-600 to-blue-500 rounded-3xl animate-spin opacity-75 blur-sm"></div>
            <Mail className="h-10 w-10 text-white relative z-10" />
            <Sparkles className="absolute -top-2 -right-2 h-6 w-6 text-yellow-400 animate-bounce" />
          </div>
          <h1 className="text-6xl md:text-7xl font-black bg-gradient-to-r from-indigo-600 via-blue-600 to-blue-500 bg-clip-text text-transparent mb-6 tracking-tight">
            Let's Create Magic
          </h1>
          <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium">
            Transform your ideas into reality. We're here to make extraordinary
        ...
        >
          {stats.map((stat, index) => (
            <div
              key={index}
              className="bg-white/60 backdrop-blur-lg p-6 rounded-3xl shadow-xl border border-white/30 text-center hover:transform hover:scale-105 transition-all duration-300 hover:shadow-2xl"
            >
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          >
            ...
            <div className="bg-gradient-to-br from-indigo-600 via-blue-600 to-blue-500 p-8 rounded-3xl shadow-2xl text-white relative overflow-hidden">
          ...
          >
            <div className="bg-white/80 backdrop-blur-xl p-10 lg:p-12 rounded-3xl shadow-2xl border border-white/40 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/5 via-blue-500/5 to-blue-400/5"></div>
              <div className="relative z-10">
                <div className="text-center mb-10">
                  <h3 className="text-4xl font-black bg-gradient-to-r from-indigo-600 via-blue-600 to-blue-500 bg-clip-text text-transparent mb-4">
                    Send us a Message
                  </h3>
                ...
                {isSubmitted ? (
                  <div className="text-center py-16">
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-indigo-600 via-blue-600 to-blue-500 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                    >
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="group">
                        ...
                        {fieldErrors.firstName && (
                          <p
                            id="firstName-error"
                            className="mt-3 text-red-600 font-medium animate-pulse"
                            role="alert"
                          >
                            {fieldErrors.firstName}
                          </p>
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-indigo-600 via-blue-600 to-blue-500 text-white py-6 rounded-2xl font-bold text-xl shadow-2xl hover:shadow-indigo-500/50 transform hover:scale-[1.02] transition-all duration-500 flex items-center justify-center space-x-4 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none focus:outline-none focus:ring-4 focus:ring-indigo-500/30 relative overflow-hidden group"
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-indigo-700 via-blue-700 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
